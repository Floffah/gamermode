...
GamerMode is a Minecraft Java Edition server software written (almost) from scratch in typescript.

The reason i put almost is because i used certain libraries to help with server development. These are currently just varint. Everything else isnt related to the server its self or is built in to node.
